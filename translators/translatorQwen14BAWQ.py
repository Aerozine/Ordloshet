"""Qwen 2.5-14B-Instruct AWQ 4-bit adapter — higher-quality patcher (~8GB VRAM).

Doubles the parameter count of the 7B patcher for significantly better instruction
following: fewer name drops, tighter length control, better register consistency.
Fits within 12GB VRAM with AWQ 4-bit quantization.
"""
import json
...
class _Qwen14BAWQ(LLMBaseAWQ):
    MODEL_ID = "Qwen/Qwen2.5-14B-Instruct-AWQ"
    LABEL = LABEL
    MODEL_SIZE_MSG = "~8GB (AWQ 4-bit)"
